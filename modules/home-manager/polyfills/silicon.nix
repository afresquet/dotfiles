# https://github.com/nix-community/home-manager/pull/5387
{
  pkgs,
  lib,
  config,
...
in
{
  ...
  config = mkIf cfg.enable {
    ...
    xdg.configFile = mkMerge (
      ...
      ++ (flip mapAttrsToList cfg.syntaxes (
        name: val: {
    ...
    home.activation.siliconCache = hm.dag.entryAfter [ "linkGeneration" ] ''
      (
        ...
        mkdir -p ${escapeShellArg config.xdg.configHome}/silicon/{themes,syntaxes}
